...
<body>
    ...
    <nav class="navbar navbar-expand-sm fixed-top">
        ...
        <div>
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a href="user_register_event.html" class="nav-link">Register to event?</a></li>
    ...
    <div class="offset-sm-1 col-sm-5">
                <div class="event-content">
                    <h4>Smart Computing and Informatics</h4>
                    <span>
                    The scope of the International Conference on SCI 2024 is to provide an International 
                    forum for the exchange of ideas among interested researchers, students academicians
                     and practitioners in the area of Smart Computing and Informatics.
                    </span><br>
